...
public enum Opcode {
    ...
    public abstract void invoke(ShareData shareData, ThreadPrivateData threadPrivateData,byte[] currentInstruction) throws NoSuchMethodException;


    //获得常量池中的值
    Object getVal(ConstantPool constantPool,short index) throws ConstantPool.InvalidIndex {
